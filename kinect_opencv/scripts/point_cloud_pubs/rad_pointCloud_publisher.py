...
def start_node():
    ...
    rospy.init_node('radiation_front_processor')
    rospy.loginfo('radiation_front_processor node started')
...
if __name__ == '__main__':
    try:
        pointcloud_publisher = rospy.Publisher("/radiation_front_pointcloud_topic", PointCloud, queue_size = 10)
        start_node()
