...
def process_camera(image, camera_info, depth):
    ...
    try:
        ...
        listener.waitForTransform("/odom","/temperature_right_link", rospy.Time(0), rospy.Duration(3.0))
        (trans,rot) = listener.lookupTransform("/odom","/temperature_right_link", rospy.Time(0))
...
if __name__ == '__main__':
    try:
        pointcloud_publisher = rospy.Publisher("/temperature_right_pointcloud_topic", PointCloud2, queue_size = 10)
        start_node()
