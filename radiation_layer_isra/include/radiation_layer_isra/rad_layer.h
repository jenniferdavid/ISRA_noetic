...
#include <radiation_layer_isra/RadiationLayerConfig.h>
...
private:
  ...
  void reconfigureCB(radiation_layer_isra::RadiationLayerConfig &config, uint32_t level);
  dynamic_reconfigure::Server<radiation_layer_isra::RadiationLayerConfig> *dsrv_;
